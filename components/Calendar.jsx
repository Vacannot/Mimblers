    ...
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-5 gap-4">
        <button
          ...
          className="mr-auto text-azure-radiance-400 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
        ...
        <button
          ...
          className="ml-auto text-azure-radiance-400 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
                ...
                return (
                  <div
                    ...
                    className={
                      ...
                      (isToday
                        ? " border-azure-radiance-400"
                        : " border-azure-radiance-100") +
                      (color === "white"
                        ? " text-azure-radiance-400"
                        : " text-white")
                    }
                    key={dayOfWeekIndex}
                  >
